# Contributing to Starter Antd Admin (Crud & auth) Mern App (Express.js / React / Redux / MongoDB) projects
...
- To report security vulnerabilities, please create new issue
